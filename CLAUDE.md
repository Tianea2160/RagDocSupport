...
- **`mcp`** — 4개 MCP 도구 (`@Tool` 어노테이션 기반): docs-register, docs-search, docs-compare, docs-list
...
- Kotlin 2.2 / Java 24 / Spring Boot 4.0.5
...
- `doc-sources.yml` — 라이브러리별 문서 URL 템플릿 (`{version}`, `{major}`, `{majorMinor}` 플레이스홀더)
